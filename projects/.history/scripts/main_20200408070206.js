...
function trackAdd() {
    ...
    var node0, node1, node2, node3, node4, node5, node6, node7, node8, node9 = document.createElement("LI");
    var textnode0 = document.createTextNode("Professional");
    ...
    document.getElementById("tracklist").appendChild(node0);
