...
for (var i = 0; i <= 4; i++) {
    if (album_item[0].style.order = 1) {
        ...
        document.getElementById("tracklist").innerHTML = "<ol><li><a class='track' href='#'>HI</a></li></ol>";
        // for (var i = 0; i <= 10; i++) {
        //     document.getElementById("tracklist").innerHTML = "<li><a class='track' href='#'></a></li>";
        // }

        document.getElementById("tracklist").innerHTML = "</ol>";
