...
for (var i = 0; i <= 4; i++) {
    if (album_item[0].style.order = 1) {
        ...
        document.getElementById("tracklist").innerHTML = " <
            ol >
            <
            li id = "track-one" > < a href = "#" > Real Life < /a></li >
            <
            li id = "track-two" > < a href = "#" > Losers < /a></li >
            <
            li id = "track-three" > < a href = "#" > Tell Your Friends < /a></li >
            <
            li id = "track-four" > < a href = "#" > Often < /a></li >
            <
            li id = "track-five" > < a href = "#" > The Hills < /a></li >
            <
            li id = "track-six" > < a href = "#" > Acquainted < /a></li >
            <
            li id = "track-seven" > < a href = "#" > Can 't Feel My Face</a></li> <
            li id = "track-eight" > < a href = "#" > Shameless < /a></li >
            <
            li id = "track-nine" > < a href = "#" > Earned It < /a></li >
            <
            li id = "track-ten" > < a href = "#" > In The Night < /a></li >
            <
            li id = "track-eleven" > < a href = "#" > As You Are < /a></li >
            <
            li id = "track-twelve" > < a href = "#" > Dark Times < /a></li >
            <
            li id = "track-thirteen" > < a href = "#" > Prisoner < /a></li >
            <
            li id = "track-fourteen" > < a href = "#" > Angel < /a></li >
            <
            /ol>";
